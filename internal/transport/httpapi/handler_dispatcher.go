...
func (h *DispatchHandler) HandleDispatcher(w http.ResponseWriter, r *http.Request) {
	...
	shards := map[string]interface{}{
		...
		"weblink_get":        []map[string]string{{"url": h.externalURL + "/public/"}},
		"weblink_view":       []map[string]string{{"url": h.externalURL + "/public/"}},
		"weblink_video":      []map[string]string{{"url": h.externalURL + "/video/"}},
		"weblink_thumbnails": []map[string]string{{"url": h.externalURL + "/public/thumb/"}},
		"video":              []map[string]string{{"url": h.externalURL + "/video/"}},
		"view_direct":        []map[string]string{{"url": h.externalURL + "/public/"}},
		"stock":              []map[string]string{{"url": h.externalURL + "/public/"}},
